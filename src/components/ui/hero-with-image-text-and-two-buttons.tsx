        ...
        <div className="grid grid-cols-1 gap-8 items-center lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 max-w-prose">
              We help you navigate the complexities of Medicare coverage, from Original Medicare
              to Medicare Advantage plans and supplement policies. Get personalized assistance
          ...
          <div className="rounded-xl overflow-hidden shadow-xl">
            <img 
              src="/lovable-uploads/e8c15049-4d4a-4071-b6b6-280f7e5676ea.png" 
              alt="Senior couple reviewing Medicare options with advisor" 
